/*
1.  ƒана последовательность натуральных чисел (одно число в строке), завершающа€с€ числом 0. 
	ќпределите, какое количество элементов этой последовательности, равны ее наибольшему элементу.

2.	ƒан линейный однонаправленный список. ¬ывести значени€ узлов списка по правилу: 
